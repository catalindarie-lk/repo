...
#define CLIENT_MAX_TREADS_PROCESS_FRAME             1                     // Number of threads dedicated to processing received frames
...
typedef struct{
    ...
    char dirpath[MAX_PATH];                       // Full path to the file on the client
